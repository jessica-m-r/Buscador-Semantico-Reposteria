...
const translations = {
    'es': {
        ...
        // Secciones
        localOntologyResults: 'Resultados de la Ontología Local',
        ...
        tryChangingLanguage: 'Intenta cambiar el idioma o realizar otra búsqueda',
        performSearch: 'Realiza una búsqueda para ver resultados locales',
    ...
    'fr': {
        ...
        search: 'Rechercher',
        searchPlaceholder: 'Recherchez des brownies, gâteaux, chocolat, ingrédients...',
        searchingIn: 'Recherche en:',
        
        localResults: 'Résultats Locaux',
        dbpediaResults: 'Résultats DBpedia',
        
        localOntologyResults: 'Résultats de l\'Ontologie Locale',
        dbpediaResultsTitle: 'Résultats depuis DBpedia',
        ...
        noLocalResults: 'Aucun résultat local trouvé en',
        tryChangingLanguage: 'Essayez de changer la langue ou effectuez une autre recherche',
        performSearch: 'Effectuez une recherche pour voir les résultats locaux',
        
        searching: 'Recherche sur DBpedia',
        pleaseWait: 'Cela peut prendre quelques secondes',
        noResults: 'Aucun résultat trouvé sur DBpedia',
        error: 'Erreur lors du chargement des résultats DBpedia',
    ...
    'de': {
        ...
        tryChangingLanguage: 'Versuchen Sie die Sprache zu ändern oder eine andere Suche durchzuführen',
        performSearch: 'Führen Sie eine Suche durch, um lokale Ergebnisse zu sehen',
        ...
        <div class="thumbnail-container">
            ${item.thumbnail 
                ? `<img src="${item.thumbnail}" alt="${item.nombre || 'Imagen'}" 
                     onerror="this.parentElement.innerHTML='<div class=\\'no-thumbnail\\'>🖼️ ${t('imageNotAvailable', language)}</div>'">` 
                : `<div class="no-thumbnail">🖼️ ${t('noImageAvailable', language)}</div>`}
        </div>
    `;
            ...
            if (key === 'dbpedia_uri') {
                html += `
                    <div class="attribute-item">
                        <div class="attribute-key">🔗 ${t('viewOnDBpedia', language)}</div>
